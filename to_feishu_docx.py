...
def clean_markdown_content_for_daily_docs(markdown_content):
    ...
    **参考**：
    ...
    # 保存响应内容到文件
    latest_summary_cleaned = os.path.join(os.path.dirname(__file__), "process_files", "latest_summary_cleaned.md")
    try:
...
if __name__ == "__main__":
    ...
    def test_write_to_docx():
        ...
        markdown_file_path = os.path.join(os.path.dirname(__file__), "process_files", "latest_summary.md")
